...
class AuthLogin(Resource):
    def post(self):
        ...
        parser.add_argument('email', type=str, help='Enter your e-mail address', required=True)
...
class AuthRegister(Resource):
    def post(self):
        ...
        parser.add_argument('first_name', type=str, help='You need to enter your first name', required=True)
        parser.add_argument('last_name', type=str, help='You need to enter your last name', required=True)
